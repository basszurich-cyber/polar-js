...
```typescript
import { Oauth2ClientsOauth2UpdateClientRequest } from "@spaire/sdk/models/operations/oauth2clientsoauth2updateclient.js";

let value: Oauth2ClientsOauth2UpdateClientRequest = {
  clientId: "<id>",
  oAuth2ClientConfigurationUpdate: {
    redirectUris: [
      "https://ornate-hydrolyse.info/",
      "https://chubby-forgery.org/",
    ],
    clientName: "<value>",
    clientId: "<id>",
  },
