...
```typescript
import { RefundsListResponse } from "@spaire/sdk/models/operations/refundslist.js";

let value: RefundsListResponse = {
  result: {
    items: [
      {
        createdAt: new Date("2025-10-30T22:59:40.030Z"),
        modifiedAt: new Date("2026-08-14T03:01:16.173Z"),
        id: "<value>",
        metadata: {
          "key": 933688,
        },
