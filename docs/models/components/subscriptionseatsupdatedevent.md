...
```typescript
import { SubscriptionSeatsUpdatedEvent } from "@spaire/sdk/models/components/subscriptionseatsupdatedevent.js";
...
| `name`                                                                                                                         | *"subscription.seats_updated"*                                                                                                 | :heavy_check_mark:                                                                                                             | The name of the event.                                                                                                         |                                                                                                                                |
