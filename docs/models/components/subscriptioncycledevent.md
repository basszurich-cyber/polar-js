...
```typescript
import { SubscriptionCycledEvent } from "@spaire/sdk/models/components/subscriptioncycledevent.js";

let value: SubscriptionCycledEvent = {
  id: "<value>",
...
| `name`                                                                                                                         | *"subscription.cycled"*                                                                                                        | :heavy_check_mark:                                                                                                             | The name of the event.                                                                                                         |                                                                                                                                |
| `metadata`                                                                                                                     | [components.SubscriptionCycledMetadata](../../models/components/subscriptioncycledmetadata.md)                                 | :heavy_check_mark:                                                                                                             | N/A                                                                                                                            |                                                                                                                                |