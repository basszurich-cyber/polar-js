...
```typescript
import { BalanceRefundEvent } from "@spaire/sdk/models/components/balancerefundevent.js";

let value: BalanceRefundEvent = {
  id: "<value>",
...
| `name`                                                                                                                         | *"balance.refund"*                                                                                                             | :heavy_check_mark:                                                                                                             | The name of the event.                                                                                                         |                                                                                                                                |
