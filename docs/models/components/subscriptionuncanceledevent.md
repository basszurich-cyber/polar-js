...
```typescript
import { SubscriptionUncanceledEvent } from "@spaire/sdk/models/components/subscriptionuncanceledevent.js";

let value: SubscriptionUncanceledEvent = {
  id: "<value>",
...
| `name`                                                                                                                         | *"subscription.uncanceled"*                                                                                                    | :heavy_check_mark:                                                                                                             | The name of the event.                                                                                                         |                                                                                                                                |
| `metadata`                                                                                                                     | [components.SubscriptionUncanceledMetadata](../../models/components/subscriptionuncanceledmetadata.md)                         | :heavy_check_mark:                                                                                                             | N/A                                                                                                                            |                                                                                                                                |