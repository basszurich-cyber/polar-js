...
```typescript
import { ListResourceWebhookDelivery } from "@spaire/sdk/models/components/listresourcewebhookdelivery.js";

let value: ListResourceWebhookDelivery = {
  items: [
    {
      createdAt: new Date("2025-12-17T00:56:00.264Z"),
      modifiedAt: new Date("2025-04-10T03:53:53.371Z"),
      id: "<value>",
      succeeded: false,
      httpCode: 446043,
      response: "<value>",
