...
```typescript
import { SubscriptionCreatedEvent } from "@spaire/sdk/models/components/subscriptioncreatedevent.js";
...
| `name`                                                                                                                         | *"subscription.created"*                                                                                                       | :heavy_check_mark:                                                                                                             | The name of the event.                                                                                                         |                                                                                                                                |
| `metadata`                                                                                                                     | [components.SubscriptionCreatedMetadata](../../models/components/subscriptioncreatedmetadata.md)                               | :heavy_check_mark:                                                                                                             | N/A                                                                                                                            |                                                                                                                                |