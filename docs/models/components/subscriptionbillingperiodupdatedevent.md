...
```typescript
import { SubscriptionBillingPeriodUpdatedEvent } from "@spaire/sdk/models/components/subscriptionbillingperiodupdatedevent.js";

let value: SubscriptionBillingPeriodUpdatedEvent = {
  id: "<value>",
...
| `customerId`                                                                                                                   | *string*                                                                                                                       | :heavy_check_mark:                                                                                                             | ID of the customer in your Spaire organization associated with the event.                                                       |                                                                                                                                |
...
| `source`                                                                                                                       | *"system"*                                                                                                                     | :heavy_check_mark:                                                                                                             | The source of the event. `system` events are created by Spaire. `user` events are the one you create through our ingestion API. |                                                                                                                                |
| `name`                                                                                                                         | *"subscription.billing_period_updated"*                                                                                        | :heavy_check_mark:                                                                                                             | The name of the event.                                                                                                         |                                                                                                                                |
| `metadata`                                                                                                                     | [components.SubscriptionBillingPeriodUpdatedMetadata](../../models/components/subscriptionbillingperiodupdatedmetadata.md)     | :heavy_check_mark:                                                                                                             | N/A                                                                                                                            |                                                                                                                                |