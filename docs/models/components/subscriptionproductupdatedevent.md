...
```typescript
import { SubscriptionProductUpdatedEvent } from "@spaire/sdk/models/components/subscriptionproductupdatedevent.js";

let value: SubscriptionProductUpdatedEvent = {
  id: "<value>",
...
| `name`                                                                                                                         | *"subscription.product_updated"*                                                                                               | :heavy_check_mark:                                                                                                             | The name of the event.                                                                                                         |                                                                                                                                |
| `metadata`                                                                                                                     | [components.SubscriptionProductUpdatedMetadata](../../models/components/subscriptionproductupdatedmetadata.md)                 | :heavy_check_mark:                                                                                                             | N/A                                                                                                                            |                                                                                                                                |