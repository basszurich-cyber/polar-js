...
```typescript
import { CheckoutCreatedEvent } from "@spaire/sdk/models/components/checkoutcreatedevent.js";

let value: CheckoutCreatedEvent = {
  id: "<value>",
...
| `name`                                                                                                                         | *"checkout.created"*                                                                                                           | :heavy_check_mark:                                                                                                             | The name of the event.                                                                                                         |                                                                                                                                |
| `metadata`                                                                                                                     | [components.CheckoutCreatedMetadata](../../models/components/checkoutcreatedmetadata.md)                                       | :heavy_check_mark:                                                                                                             | N/A                                                                                                                            |                                                                                                                                |