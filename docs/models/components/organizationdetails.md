...
```typescript
import { OrganizationDetails } from "@spaire/sdk/models/components/organizationdetails.js";
...
| `intendedUse`                                                        | *string*                                                             | :heavy_check_mark:                                                   | How the organization will integrate and use Spaire.                   |
