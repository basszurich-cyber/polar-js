...
```typescript
import { BalanceDisputeEvent } from "@spaire/sdk/models/components/balancedisputeevent.js";

let value: BalanceDisputeEvent = {
  id: "<value>",
...
| `name`                                                                                                                         | *"balance.dispute"*                                                                                                            | :heavy_check_mark:                                                                                                             | The name of the event.                                                                                                         |                                                                                                                                |
