...
```typescript
import { CustomerDeletedEvent } from "@spaire/sdk/models/components/customerdeletedevent.js";

let value: CustomerDeletedEvent = {
  id: "<value>",
...
| `name`                                                                                                                         | *"customer.deleted"*                                                                                                           | :heavy_check_mark:                                                                                                             | The name of the event.                                                                                                         |                                                                                                                                |
