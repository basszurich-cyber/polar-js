...
```typescript
import { BalanceDisputeReversalEvent } from "@spaire/sdk/models/components/balancedisputereversalevent.js";

let value: BalanceDisputeReversalEvent = {
  id: "<value>",
...
| `name`                                                                                                                         | *"balance.dispute_reversal"*                                                                                                   | :heavy_check_mark:                                                                                                             | The name of the event.                                                                                                         |                                                                                                                                |
| `metadata`                                                                                                                     | [components.BalanceDisputeMetadata](../../models/components/balancedisputemetadata.md)                                         | :heavy_check_mark:                                                                                                             | N/A                                                                                                                            |                                                                                                                                |