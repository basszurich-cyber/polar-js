...
```typescript
import { UserEvent } from "@spaire/sdk/models/components/userevent.js";
...
| `source`                                                                                                                       | *"user"*                                                                                                                       | :heavy_check_mark:                                                                                                             | The source of the event. `system` events are created by Spaire. `user` events are the one you create through our ingestion API. |                                                                                                                                |
