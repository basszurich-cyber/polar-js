...
```typescript
import { SubscriptionRevokedEvent } from "@spaire/sdk/models/components/subscriptionrevokedevent.js";
...
| `name`                                                                                                                         | *"subscription.revoked"*                                                                                                       | :heavy_check_mark:                                                                                                             | The name of the event.                                                                                                         |                                                                                                                                |
