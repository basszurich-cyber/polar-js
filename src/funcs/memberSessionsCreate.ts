...
import {
  MemberSession,
  MemberSession$inboundSchema,
} from "../models/components/membersession.js";
import {
  MemberSessionCreate,
  MemberSessionCreate$outboundSchema,
} from "../models/components/membersessioncreate.js";
import {
  ConnectionError,
  InvalidRequestError,
  RequestAbortedError,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(MemberSessionCreate$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, MemberSession$inboundSchema),
